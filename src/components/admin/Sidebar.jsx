...
const sidebarItems = [
  {
    section: "Main",
    items: [
      { title: "Dashboard", to: "/admindashboard", icon: <HomeOutlinedIcon /> },
    ],
  },
  {
    section: "Data",
    items: [
      { title: "Porters", to: "/admindashboard/view-porters", icon: <PeopleOutlinedIcon /> },
      { title: "Farmers", to: "/admindashboard/view-farmers", icon: <ContactsOutlinedIcon /> },
      { title: "Records", to: "/admindashboard/records", icon: <ReceiptOutlinedIcon /> },
    ],
  },
  {
    section: "Pages",
    items: [
      { title: "Porters summary", to: "/admindashboard/summary", icon: <PersonOutlinedIcon /> },
      { title: "Calendar", to: "/admindashboard/calendar", icon: <CalendarTodayOutlinedIcon /> },
