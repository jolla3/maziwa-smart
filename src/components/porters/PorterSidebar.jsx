...
const sidebarItems = [
  {
    section: "Main",
    items: [
      { title: "Dashboard", to: "/porterdashboard", icon: <HomeOutlinedIcon /> },
    ],
  },
  {
    section: "Data",
    items: [
      {
        title: "My Profile",
        to: "/porterdashboard/myprofile",
        icon: <PeopleOutlinedIcon />,
      },
      {
        title: "Add Milk",
        to: "/porterdashboard/addmilk",
        icon: <ContactsOutlinedIcon />,
      },
      {
        title: "My Farmer Records",
        to: "/porterdashboard/records",
  ...
  },
  {
    ...
    items: [
      {
        title: "Porters monthly summary",
        to: "/porterdashboard/monthly",
        icon: <PersonOutlinedIcon />,
      },
      {
        title: "Calendar",
        to: "/porterdashboard/calendar",
